...
abstract class AppLocalizations {
  ...
  /// No description provided for @questionRemovedFromSaved.
  ///
  /// In en, this message translates to:
  /// **'Question removed from saved!'**
  String get questionRemovedFromSaved;

  /// No description provided for @questionAlreadySaved.
  ///
  /// In en, this message translates to:
  /// **'Question already saved!'**
  String get questionAlreadySaved;
  ...
  /// No description provided for @savedQuestionsTitle.
  ///
  /// In en, this message translates to:
  /// **'Saved'**
  String get savedQuestionsTitle;

  /// No description provided for @favoriteQuestionsTitle.
  ///
  /// In en, this message translates to:
  /// **'Favorite'**
  String get favoriteQuestionsTitle;
